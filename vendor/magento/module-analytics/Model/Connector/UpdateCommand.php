    ...
    public function execute()
    {
        ...
        if ($this->analyticsToken->isTokenExist()) {
            ...
            if (!$result) {
				 ...
				 * "«Update of the subscription for MBI service has been failed:
				 * Not authorized.. Content-Type: text/plain;charset=UTF-8»":
				 * https://github.com/vegandthecity/magento/issues/14
				 */
            	df_log_l($this, 'Update of the subscription for MBI service has been failed', 'MBI');
                $this->logger->warning(
                    sprintf(
