            ...
            try {
                ...
                if (!$retry) {
                    ...
                    if ($pdoException && isset($this->exceptionMap[$pdoException->errorInfo[1]])) {
						...
						/**
						 * 2020-05-09 Dmitry Fedyuk https://www.upwork.com/fl/mage2pro
						 * «Integrity constraint violation:
						 * 1062 Duplicate entry <…> at vendor/magento/framework/DB/Statement/Pdo/Mysql.php:91» /
						 * «Unique constraint violation found
						 * at vendor/magento/framework/EntityManager/Operation/Update.php:121»:
						 * https://github.com/vegandthecity/magento/issues/45
						 */
						df_log_l($this, [
							'bind' => $bind
							,'message' => $e->getMessage()
							,'pdoException' => $pdoException->errorInfo[1]
							,'sql' => $sql
						], $e->getTraceAsString());
