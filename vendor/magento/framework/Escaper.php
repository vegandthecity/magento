    ...
    public function escapeHtml($data, $allowedTags = null)
    {
        ...
        if (is_array($data)) {
            ...
            if (is_array($allowedTags) && !empty($allowedTags)) {
                ...
                set_error_handler(
                    function ($errorNumber, $errorString) use($allowedTags, $data) {
                        // phpcs:ignore Magento2.Exceptions.DirectThrow
						// 2020-05-08 Dmitry Fedyuk https://www.upwork.com/fl/mage2pro
						// "«DOMDocument::loadHTML(): Tag date invalid in Entity, line: 1
						// at vendor/magento/framework/Escaper.php:89»":
						// https://github.com/vegandthecity/magento/issues/41
						df_log_l($this, [
