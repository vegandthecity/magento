...
class Connection implements ConnectionInterface
{
    ...
    private function process4xxError($request, $response, $ignore)
    {
		 ...
		 * "Elasticsearch: `query_shard_exception`:
		 * «failed to create query» / `search_phase_execution_exception`: «all shards failed»
		 * at vendor/elasticsearch/elasticsearch/src/Elasticsearch/Connections/Connection.php:636":
		 * https://github.com/vegandthecity/magento/issues/42
		 */
        df_log_l($this, [
			'request' => $request
