...
abstract class AbstractElement extends \Magento\Framework\DataObject
{
    ...
    public function getElementFields($elements, $key = '')
    {
        ...
        foreach ($elements as $k => $element) {
            ...
            if (isset($field['config']['className'])) {
                $field['config']['className'] .= ' mgz-element-' . $id . ' mgz-builder-' . $element->getType();
            } else {
                $field['config']['className'] = 'mgz-element-' . $id . ' mgz-builder-' . $element->getType();
            }
            ...
            if ($type=='container' || $type=='fieldset' || $type=='containerGroup') {
                if (isset($field['config']['templateOptions']['wrapperClass'])) {
                    $field['config']['templateOptions']['wrapperClass'] .= ' ' . $field['config']['className'];
                } else {
                    $field['config']['templateOptions']['wrapperClass'] = ' ' . $field['config']['className'];
                }
    ...
    public function prepareGeneralTab()
    {
        $general = $this->addTab(
                ...
                $common2->addChildren(
                    ...
                    [
                        ...
                        'templateOptions' => [
                            ...
                            'note'  => __('If checked this element won\'t be visible on the public side of your website. You can switch it back any time.')
                        ]
                    ]
                );
            ...
            if (!$this->getData('resizable')) {
                $common6 = $general->addContainerGroup(
                    'common6',
                    [
                        'sortOrder' => 560
                    ]
                    ...
                    $common6->addChildren(
                        ...
                        [
                            ...
                            'key'             => 'lg_hide',
                            'templateOptions' => [
                                'label' => __('Hide on Tablet Landscape')
                            ]
                        ]
                    );
                ...
                $common7 = $general->addContainerGroup(
                    'common7',
                    [
                        'sortOrder' => 570
                    ]
                    ...
                    $common7->addChildren(
                        ...
                        [
                            ...
                            'key'             => 'sm_hide',
                            'templateOptions' => [
                                'label' => __('Hide on Mobile Landscape')
                            ]
                        ]
                    );
                    ...
                    $common7->addChildren(
                        ...
                        [
                            ...
                            'key'             => 'xs_hide',
                            'templateOptions' => [
                                'label' => __('Hide on Mobile Portrait')
                            ]
                        ]
                    );
    ...
    public function prepareModeCssBox($parent, $prefix = '')
    {
        ...
        $parent->addChildren(
            ...
            $borderRadius = $parent->addFieldset(
                ...
                [
                    ...
                    'templateOptions' => [
                        'additionalClasses' => 'mgz-design-radius',
                        'label'             => __('Radius'),
                        'focus'             => true
                    ]
                ]
                ...
                $borderRadius->addChildren(
                    ...
                    $margin = $borderRadius->addFieldset(
                        ...
                        [
                            'sortOrder'       => 100,
                            'templateOptions' => [
                                'additionalClasses' => 'mgz-design-margin',
                                'label'             => __('Margin')
                            ]
                        ]
                    );
                        ...
                        $border = $margin->addFieldset(
                            ...
                            [
                                ...
                                'templateOptions' => [
                                    'label'             => __('Border'),
                                    'additionalClasses' => 'mgz-design-border'
                                ]
                            ]
                        );
                            ...
                            $padding = $border->addFieldset(
                                ...
                                $padding->addChildren(
                                    ...
                                    'html',
                                    [
                                        'className'       => 'mgz-design-unit mgz-padding-unit',
                                        'sortOrder'       => 50,
                                        'templateOptions' => [
        ...
        $parent->addChildren(
            ...
            [
                ...
                'hideExpression' => 'model.background_type!="yt_vm_video"'
            ]
        );
        ...
        $parent->addChildren(
            ...
            [
                ...
                'hideExpression' => 'model.background_position!="custom"'
            ]
        );
    ...
    public function getHoverEffect()
    {
        return [
            ...
            [
                'label' => __('Reveal Down'),
                'value' => 'reveal-down'
            ],
            [
                'label' => __('Reveal Left'),
                'value' => 'reveal-left'
            ],
            [
                'label' => __('Reveal Right'),
                'value' => 'reveal-right'
            ],
            [
                'label' => __('Hinge Up'),
            ...
            [
                'label' => __('Flip Diag 1'),
                'value' => 'flip-diag-1'
            ],
            [
                'label' => __('Flip Diag 2'),
                'value' => 'flip-diag-2'
            ],
            [
                'label' => __('Shutter Out Horizontal'),
                'value' => 'shutter-out-horiz'
            ],
            [
                'label' => __('Shutter Out Vertical'),
                'value' => 'shutter-out-vert'
            ],
            [
                'label' => __('Shutter Out Diag 1'),
                'value' => 'shutter-out-diag-1'
            ],
            [
                'label' => __('Shutter Out Diag 2'),
                'value' => 'shutter-out-diag-2'
            ],
            [
                'label' => __('Shutter In Horizontal'),
                'value' => 'shutter-in-horiz'
            ],
            [
                'label' => __('Shutter In Vertical'),
                'value' => 'shutter-in-vert'
            ],
            [
                'label' => __('Shutter In Out Horizontal'),
                'value' => 'shutter-in-out-horiz'
            ],
            [
                'label' => __('Shutter In Out Vertical'),
                'value' => 'shutter-in-out-vert'
            ],
            [
                'label' => __('Shutter In Out Diag 1'),
                'value' => 'shutter-in-out-diag-1'
            ],
            [
                'label' => __('Shutter In Out Diag 2'),
                'value' => 'shutter-in-out-diag-2'
            ],
            [
                'label' => __('Fold Up'),
                'value' => 'fold-up'
            ...
            [
                'label' => __('Zoom Out Flip Horizontal'),
                'value' => 'zoom-out-flip-horiz'
            ],
            [
                'label' => __('Zoom Out Flip Vertical'),
