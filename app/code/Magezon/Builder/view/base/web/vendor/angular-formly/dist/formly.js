...
/***/ function(module, exports, __webpack_require__) {
	...
	function formlyForm(formlyUsability, formlyWarn, $parse, formlyConfig, $interpolate) {
	  ...
	  function formlyFormLink(scope, el, attrs) {
	    ...
	    var wrapperClass;
	    if (attrs.hasOwnProperty('isFieldGroup') || (scope.$parent.to && scope.$parent.to.wrapperClass)) {
	    	wrapperClass = scope.$parent.to.wrapperClass;
	    	$(el).closest('.formly-field').addClass(wrapperClass);
		}
