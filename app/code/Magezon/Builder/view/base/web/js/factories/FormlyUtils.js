define([
    ...
    var processFields = function(array, separator, level, key) {
        ...
        for (i; i < length; i++) {
            ...
            if (elem.type) {
                elem['className'] += ' mgz-element-' + elem.type;
            }
    ...
    var getDefaultValues = function(element) {
        ...
        defaultValues['component'] = getComponentDefault();
    ...
    return {
        ...
        // processDefaultValues: processDefaultValues,
        //getComponentDefault: getComponentDefault
    }
});