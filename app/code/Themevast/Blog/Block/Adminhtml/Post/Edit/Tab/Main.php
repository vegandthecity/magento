<?php
/**
 * Copyright © 2015 Themevast.com. All rights reserved.

 * @author Themevast Team <contact@themevast.com>
 */

namespace Themevast\Blog\Block\Adminhtml\Post\Edit\Tab;
...
class Main extends \Magento\Backend\Block\Widget\Form\Generic implements \Magento\Backend\Block\Widget\Tab\TabInterface
{
    ...
    /**
     * @var \Themevast\Blog\Model\ResourceModel\Category\Collection
     */
    ...
    protected function _prepareForm()
    {
         ...
         */
        $isElementDisabled = !$this->_isAllowedAction('Themevast_Blog::post');
		...
		$fieldset->addField(
            ...
            [
                ...
                'name' => 'post[author_id]',
               /*  'required' => true, */
                'values' => $this->_objectManager->create('Themevast\Blog\Model\Config\Source\Author')->toOptionArray(),
                'disabled' => $isElementDisabled
            ]
        );
        $this->_eventManager->dispatch('themevast_blog_post_edit_tab_main_prepare_form', ['form' => $form]);
