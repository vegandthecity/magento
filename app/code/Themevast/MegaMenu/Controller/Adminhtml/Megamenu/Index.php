<?php
namespace Themevast\MegaMenu\Controller\Adminhtml\Megamenu;
...
class Index extends \Magento\Backend\App\Action
{
	...
	public function execute()
    {
        ...
        $resultPage->setActiveMenu('Themevast_MegaMenu::megamenu');
    ...
    {
        return $this->_authorization->isAllowed('Themevast_MegaMenu::manage_menus');
    }	
}