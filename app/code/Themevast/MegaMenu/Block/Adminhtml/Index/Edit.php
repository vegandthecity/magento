<?php
namespace Themevast\MegaMenu\Block\Adminhtml\Index;
class Edit extends \Magento\Backend\Block\Widget\Form\Container{
	...
	protected function _construct()
	{
        ...
        $this->_blockGroup = 'Themevast_MegaMenu';
        $this->_controller = 'adminhtml_index';
		
		parent::_construct();
		
		if ($this->_isAllowedAction('Themevast_MegaMenu::save')) {
		...
		if ($this->_isAllowedAction('Themevast_MegaMenu::delete')) {
